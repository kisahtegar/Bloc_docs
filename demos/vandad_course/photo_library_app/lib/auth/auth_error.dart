...
/// Define and add all `AuthError` to `authErrorMapping`.
...
abstract class AuthError {
  ...
  /// This factory constructor take in firebase auth excecption have a lookup
  /// of that auth exception using description inside Map `authErrorMapping`.
  factory AuthError.from(FirebaseAuthException exception) =>
      authErrorMapping[exception.code.toLowerCase().trim()] ??
      const AuthErrorUnknown();
}

/// Implement Auth error unknown.
@immutable
